<template>
  <div>
    <div class="card" style="min-height: 80vh; width: 100%;">
      <div class="blog-box" v-for="item in tableData" :key="item.id" v-if="total > 0">
        <div style="flex: 1; width: 0">
          ...
          <div style="display: flex; align-items: center">
            <div style="flex: 1; font-size: 13px">
              ...
              <br>
              <span v-if="showOpt" style="margin-left: 40px; margin-top: 40px; color: red; cursor: pointer" @click="del(item.id)"><i class="el-icon-delete"></i>删除</span>
        ...
        <div style="width: 150px">
          <img style="width: 100%;  border-radius: 5px" :src="item.cover" alt="">
        </div>
      </div>
