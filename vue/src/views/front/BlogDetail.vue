  ...
  <div class="main-content" style="width: 80%">
    <div style="display: flex; grid-gap: 10px">
      ...
      <div style="flex: 1;width: 0">
        ...
        <div class="card" style="text-align: center; font-size: 20px; color: #666; margin-bottom: 10px">
          ...
          <span style="margin-right: 20px; cursor: pointer;" @click="setCollect"
            :class="{ 'active': blog.userCollect }"><i class="el-icon-star-off"></i> {{ blog.collectCount }}</span>
        </div>
      ...
      <div style="width: 260px">
          ...
          <div>
            <div style="margin-bottom: 15px" v-for="item in recommendList" :key="item.id">
              <a :href="'/front/blogDetail?blogId=' + item.id" target="_blank">
                <div class="recommend-title line2" style="color: white;">{{ item.title }}</div>
              </a>
              <div style="color: #888">
        ...
        <div class="card">
          <div style="display: flex; grid-gap: 10px; flex-direction:column;">
            <div style="flex: 1; line-height: 25px">
              “Talk is cheap. Show me the code.” —— Linus Torvalds （译：空谈无益，代码为证。）
            </div>
            <img src="../../../public/img/yuan.gif" alt="" style="width: 100%;  border-radius: 5px">
          </div>
        </div>
