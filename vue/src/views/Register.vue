<template>
  <div class="container">
    <div class="mask">
      ...
      <div
        style="height: 420px; width: 380px; padding: 50px 30px; background-color: rgb(255,255,255,.8); border-radius: 5px;">
          ...
          this.$request.post('/register', this.form).then(res => {
            if (res.code === '200') {
              this.$message.success({
                message: '注册成功,即将返回登录页面', duration: 1000
              })
              setTimeout(() => {
