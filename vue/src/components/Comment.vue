      ...
      <div style="display: flex; grid-gap: 20px; margin-bottom: 20px" v-for="item in commentList" :key="item.id">
        ...
        <div style="flex: 1">
          ...
          <div style="margin-bottom: 10px">
            <div style="color: white; margin-bottom: 10px;font-weight: bolder; font-size: 15px;">{{ item.userName }}</div>
            <div style="color: yellow; margin-bottom: 10px">{{ item.content }}</div>
            <div style="color: white; font-size: 13px; margin-bottom: 10px"><span style="margin-right: 20px">{{ item.time }}</span>
          ...
          <div style="display: flex;  grid-gap: 20px; margin-bottom: 20px" v-for="sub in item.children" :key="sub.id">
            ...
            <div style="flex: 1">
              <div style="color: white; margin-bottom: 10px">{{ sub.userName }} <span style="color: #333" v-if="sub.replyUser !== item.userName">回复  {{ sub.replyUser }}</span></div>
              <div style="color: yellow; margin-bottom: 10px">{{ sub.content }}</div>
              <div style="color: white; font-size: 13px; margin-bottom: 10px"><span style="margin-right: 20px">{{ sub.time }}</span>
